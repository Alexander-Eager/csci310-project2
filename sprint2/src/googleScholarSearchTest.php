...
class Articles{
	public function retrieveArticles($searchTearms, $numberOfResults) {
	...
	public function __construct( $searchTearms, $numberOfResults ){
		$this->retrieveArticles($searchTearms, $numberOfResults);
	}
}
?>